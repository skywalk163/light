...
- [贡献指南](../../CONTRIBUTING.md) — 完整的贡献流程和规范
- [开发指南](../DEVELOPMENT_GUIDE.md) — 开发环境搭建和代码规范
- [Pull Request 模板](../../.github/PULL_REQUEST_TEMPLATE.md) — PR 提交模板

### 新手入门任务

如果你是第一次参与开源项目，可以从以下任务开始：
...
| 项目 | 说明 |
|------|------|
| [博客系统](../../examples/blog_system/) | 基于 Web 框架的简易博客系统 |
| [待办事项 CLI](../../examples/todo_cli/) | 命令行待办事项管理工具 |
| [贪吃蛇游戏](../../examples/snake_game/) | 终端贪吃蛇游戏 |
| [天气应用](../../examples/weather_app/) | 天气查询 Web 应用 |
| [算法库](../../examples/algorithms_lib/) | 常用算法实现集合 |
...
我们非常重视每一位用户的反馈。你可以通过以下方式提供反馈：

1. **GitHub Issues**：提交 Bug 报告或功能建议
2. **GitHub Discussions**：在讨论区发起讨论
3. **反馈文档**：查看[反馈收集指南](feedback.md)了解如何提交有价值的反馈

### 用户调研

我们定期进行用户调研，了解用户需求和使用体验。欢迎参与：
...
- **建设性沟通**：提供建设性的反馈，关注问题本身
- **协作精神**：乐于分享知识，帮助他人成长
- **禁止骚扰**：不欢迎任何形式的骚扰、歧视或人身攻击

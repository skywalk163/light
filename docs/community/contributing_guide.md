...
本文档是光明开源贡献的**快速参考指南**（简洁版），与完整的 [CONTRIBUTING.md](../../CONTRIBUTING.md) 互补。适合已经熟悉 GitHub 协作流程的开发者快速查阅。
...
在 [Issues 页面](https://github.com/skywalk163/light/issues) 点击 **New Issue**，选择 Bug 报告模板。
...
├── integration/
│   └── test_light_programs.py  # 光明程序集成测试
└── e2e/
...
| 渠道 | 地址 | 说明 |
|------|------|------|
| **GitHub Issues** | [https://github.com/skywalk163/light/issues](https://github.com/skywalk163/light/issues) | Bug 报告和功能请求 |
| **GitHub Discussions** | [https://github.com/skywalk163/light/discussions](https://github.com/skywalk163/light/discussions) | 技术讨论和问题求助 |
| **文档站** | [https://skywalk163.github.io/light/](https://skywalk163.github.io/light/) | 文档和教程 |
...
2. **提供完整信息**：包括操作系统、Python 版本、光明版本、错误信息
3. **提供可复现代码**：附上最小可复现示例
4. **友善礼貌**：保持友善和尊重的沟通方式

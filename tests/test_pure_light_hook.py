...
_已转发 = {
    ...
    # 期望按宿主版本取：builtins.求和 按 sys.version_info 把「启用补偿」传给 列表工具.求和
    # （3.12+ 才走 Neumaier 补偿 → 1.0；3.11 是朴素累加 → 0.0）。CI 是 3.11。
    "求和": ("列表工具", ([1e16, 1.0, -1e16],), 1.0 if sys.version_info >= (3, 12) else 0.0),
